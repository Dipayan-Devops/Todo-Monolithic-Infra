...
sql_server = {
  server1 = {
    ...
    sql_server_name    = "myappserver07070707"
    rg_name            = "deep-rg-1"
    rg_location        = "West US"
    sql_server_version = "12.0"
    # sql_server_admin_login    = "appadmin"
    # sql_server_admin_password = "Qwerty@123456"
    minimum_tls_version  = "1.2"
    kv_name              = "myappazurekv"
    secret_name_username = "server-admin-username"
    secret_name_password = "server-admin-password"
...
sql_db = {
  ...
  db1 = {
    ...
    sql_db_name = "todosqldb_18122025"
    #   server_id    = string
...
compute = {
  compute1 = {
    ...
    # vm_username                     = "frontendadmin"
    # vm_password                     = "Qwerty@123456"
    secret_name_username            = "frontend-vm-admin-username"
    secret_name_password            = "frontend-vm-admin-password"
  ...
  compute2 = {
    ...
    vm_name = "backend-vm"
    vm_size = "Standard_D2s_v3"
    # vm_username                     = "backendadmin"
    # vm_password                     = "Qwerty@123456"
    secret_name_username            = "backend-vm-admin-username"
    secret_name_password            = "backend-vm-admin-password"
    disable_password_authentication = "false"
...
subnet_name ="AzureBastionSubnet"
vnet_name ="vnet-1"
host_name ="backend-host"
rg_location ="West US"
ip_configuration ={
  ip_conf2 ={
ip_name ="backend-ip_config"
